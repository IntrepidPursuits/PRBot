...
describe 'PullRequestParser' do
  describe '.parse' do
    context 'with github' do
      context 'with valid parameters' do
        context 'such as valid resources that do not exist' do
          it 'creates a new records for those resources' do
            PullRequestParser.parse(create_pull_request_params)
        ...
        context 'such as valid resources that do exist' do
          it 'finds the existing records for those resources' do
            team = create(:team)
    ...
    context 'with bitbucket' do
      context 'with valid parameters' do
        context 'such as valid resources that do not exist' do
          it 'creates a new records for those resources' do
            PullRequestParser.parse(create_bitbucket_pull_request_params)
        ...
        context 'such as valid resources that do exist' do
          it 'finds the existing records for those resources' do
            ...
            pull_request = PullRequestParser.parse(create_bitbucket_pull_request_params)
      ...
      context 'with valid parameters' do
        context 'such as missing parameters' do
          it 'returns nil' do
            invalid_params = create_bitbucket_pull_request_params
            invalid_params.delete(:user_id)
            bad_pull_request = PullRequestParser.parse(invalid_params)
